...
👉 TRAMPA:
Orden de la diferencia importa
"""
# --------------------------------------------------
...
1. Contar elementos
2. Determinar si está vacío
3. Encontrar el menor elemento (números)
...
# --------------------------------------------------
"""
🔥 RESUMEN FINAL (LO QUE TE HACE GANAR EL PARCIAL):

👉 UNION:
recorrer ambos e insertar

👉 INTERSECCION:
si pertenece en el otro
...
👉 TRAMPAS:
- duplicados
- cabeza en eliminación
- conjunto vacío
- orden en diferencias
"""
# --------------------------------------------------